...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "305c0cd93f65afa213d10c19fd149f97";
    ...
    protected void onResume() {
        ...
        if (city != null){
            ...
            Log.d("Clima", "Getting current city's weather");
            getWeatherForCurrentLocation();
        }

        Log.d("Clima", "Getting weather for current locaton");
        getWeatherForCurrentLocation();
    }
...
// TODO: Add letsDoSomeNetworking(RequestParams params) here:
    private void letsDoSomeNetworking(RequestParams params){
        ...
        Log.d("Clima", "Networking");
        client.get(WEATHER_URL, params, new JsonHttpResponseHandler(){

            @Override
            public void onSuccess(int satusCode, Header[] headers, JSONObject response){
